...
/// Manual ISO 8601 UTC formatter — `2026-04-25T17:43:37Z` shape.
///
/// Matches the existing project convention from
/// `resources::lsrules_files::format_unix_secs` (no chrono dependency).
...
fn days_to_ymd(days: u64) -> (u64, u8, u8) {
    // Howard Hinnant's civil_from_days, ported.
    let z = days + 719468;
    let era = z / 146097;
    let doe = z % 146097;
