...
**Empirical evidence it works:** The verify run pulled real `log-traffic` rows from a developer machine — apps, system network services, CLIs, the works. The data shape is exactly what the LLM needs.
