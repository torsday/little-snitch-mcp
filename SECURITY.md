...
1. **GitHub Private Vulnerability Reporting** (preferred): open the [Security tab](https://github.com/torsday/little-snitch-mcp/security) → "Report a vulnerability". This routes the report through GitHub's encrypted advisory workflow.
2. **Email:** `daniel@torsday.com` with subject `[little-snitch-mcp] security`.
